...
void CyInfoPythonInterface1()
{
	...
	python::class_<CvUnitInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvUnitInfo")
		...
		// Badgame mod Python definitions
		.def("isAirship", &CvUnitInfo::isAirship, "bool ()")
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvBuildingInfo")
		...
		// Badgame Exposure to Python
		.def("isApostolicPalace", &CvBuildingInfo::isApostolicPalace, "bool ()")
		.def("isEspionageBuilding", &CvBuildingInfo::isEspionageBuilding, "bool ()")
		.def("isBadgameEspionageBuilding", &CvBuildingInfo::isBadgameEspionageBuilding, "bool ()")
