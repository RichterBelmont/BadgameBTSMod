...
public:
	...
	bool isAirship() const;             // Exposed to Python
...
public:
	...
	bool isApostolicPalace() const;         // Exposed to Python
	bool isEspionageBuilding() const;       // Exposed to Python
	bool isBadgameEspionageBuilding() const;  // Exposed to Python
...
protected:
	...
	// New Badgame flags
	bool m_bNoApostolicPalaceCannotBuild;
	bool m_bNoEspionageCannotBuild;
	bool m_bNoEspionageCanBuild;
