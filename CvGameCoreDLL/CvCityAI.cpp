...
void CvCityAI::AI_chooseProduction()
{
	...
	/**
	  ...
	  * EPs are disabled and shouldn't affect AI decision-making.
	  */
		...
		if ((iFocusFlags == 0) || (iValue > 0) || (iPass == 0))
		{
			...
			else
			{
				...
				if (iFocusFlags & BUILDINGFOCUS_CULTURE)
				{
					...
					/**
					  * [Badgame] No Espionage:
					  * No change here.  As EPs no longer get converted into culture, that value
					  * should be irrelevant to AI decision-making.
					  */
					...
					/**
					  * [Badgame] No Espionage:
					  * Same deal as above, no change.  As EPs no longer get converted into culture, that value
					  * should be irrelevant to AI decision-making.
					  */
				}
...
void CvCityAI::AI_buildGovernorChooseProduction()
{
	...
	/**
	  * [Badgame] No Espionage:
	  * Don't set the Espionage flag for AI decision-making either.
	  */
...
BuildingTypes CvCityAI::AI_bestAdvancedStartBuilding(int iPass)
{
	...
	if (iPass >= 4)
	{
		...
		/**
		  * [Badgame] No Espionage:
		  * Building focus shouldn't be on Espionage for our purposes, either.
		  */
		if (!GC.getGameINLINE().isOption(GAMEOPTION_NO_ESPIONAGE) && !GC.getGameINLINE().isOption(GAMEOPTION_BADGAME_NO_ESPIONAGE))
		{
