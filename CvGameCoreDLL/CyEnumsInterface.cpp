...
void CyEnumsPythonInterface()
{
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_BADGAME_NO_ESPIONAGE", GAMEOPTION_BADGAME_NO_ESPIONAGE)
		.value("GAMEOPTION_BADGAME_NO_APOSTOLIC_PALACE", GAMEOPTION_BADGAME_NO_APOSTOLIC_PALACE)
		.value("GAMEOPTION_BADGAME_NO_AIRSHIPS", GAMEOPTION_BADGAME_NO_AIRSHIPS)
